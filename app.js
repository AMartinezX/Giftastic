var myGiffy = {
    ...
    myArray: ["godfather", "mentos", "puppies", "vin diesel", "cats", "clown fish"],
    userInput: "",
    ...
    doApiStuff: function(gifSelected) {
        ...
        $.ajax({
            type: "GET",
            url: "https://api.giphy.com/v1/gifs/search?q=" + gifSelected + "&api_key=o74riLHvsUx6u59325OHeXinSCsXJGe3"
